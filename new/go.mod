...
replace github.com/forrestlinfeng/trpcdemo => ./stub/github.com/forrestlinfeng/trpcdemo

require (
	github.com/forrestlinfeng/trpcdemo v0.0.0-00010101000000-000000000000
