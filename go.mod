...
replace github.com/some-repo/examples/hello => ./stub/github.com/some-repo/examples/hello

require (
	github.com/golang/mock v1.6.0
	github.com/some-repo/examples/hello v0.0.0-00010101000000-000000000000
